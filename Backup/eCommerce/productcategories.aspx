<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="productcategories.aspx.cs" Inherits="eCommerce.productcategories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
	...
	<div class="center_title_bar">
	  ...
	  <asp:ListView ID="ListViewCategories" OnItemCommand="ProductItemCommand" runat="server">
	   <ItemTemplate>
	   <div class="prod_box">
			...
			<div class="prod_details_tab">
			 <asp:LinkButton Text="Sepete Ekle" Font-Size="8pt" CommandName="ProductSale" CommandArgument='<%#Eval("PIC_ProdID")%>' Width="75" Height="24" CssClass="prod_buy" ID="LinkButton1" runat="server"><%=kelime["12"] %></asp:LinkButton>
